...
$_['text_frisbee'] = '<a onclick="window.open(\'https://frisbee.ua/\');"><img src="view/image/payment/frisbee.svg" alt="Frisbee" title="Frisbee" style="border: 1px solid #EEEEEE;" /></a>';
